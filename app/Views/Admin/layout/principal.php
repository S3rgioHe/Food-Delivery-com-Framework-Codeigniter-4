...
<head>
  ...
  <!-- essa section renderizarar os estilos específicos da view que estender esse layout-->
...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <!-- Essa sectopn renderizará os conteudos específicos da view que estender essa layout -->
  ...
  <script src="<?php echo site_url('admin/');?>js/jquery.cookie.js" type="text/javascript"></script>
   ...
   <!-- Essa sectopn renderizará os scripts específicos da view que estender essa layout -->
